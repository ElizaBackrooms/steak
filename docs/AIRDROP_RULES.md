...
**Ticker:** $STEAK · **Chain:** Solana · **Founder:** @lazefrito
...
| **Viral Harvest** | Event-triggered | Barn bonus | Holders + hashtag participants |
...
- 100,000,000 STEAK total from Genesis Harvest treasury.
...
- Held ≥ 1,000 STEAK during the 24h window, and
- Interacted with STEAK contracts or dashboard that week.
