...
## 5. Doc map (launch tonight)

| Doc | Purpose |
|-----|---------|
| `LAUNCH_TONIGHT.md` | Founder checklist: wallet → pump.fun → CA broadcast → 72h playbook |
| `TOKENOMICS.md` | Supply, allocation, Grazing Seasons, transparency wallets |
| `AIRDROP_RULES.md` | Genesis / Loyalty / Viral Harvest rules |
| `COMMS_PLAYBOOK.md` | Pinned tweet, launch thread, FUD replies |
| `BRAND_STRATEGY.md` | Lore, narrative, GTM rationale |
...
- [ ] Genesis Harvest countdown (72h from T-0)
- [ ] Transparency wallets filled in `TOKENOMICS.md` §7
