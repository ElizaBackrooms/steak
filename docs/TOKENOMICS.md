...
| 🥩 **Prime Cut** | 90 days | 4x | Eligible for Loyalty Harvest. |
...
- **Genesis Harvest (T+0 to T+72h):** 100M STEAK pool — 1,000 STEAK per Genesis NFT (cap 10k) + pro-rata remainder by marination points.
- **Loyalty Harvest (weekly, "Butcher Day" = every Sunday 00:00 UTC):** 1% of Barn treasury pro-rata to active Yearling+ stakers (21+ days in tier, ≥ 25k staked).
- **Viral Harvest (event-triggered):** if a `#STEAK` or `#BottleFedToBlockchain` post exceeds 100K impressions in 24h, bonus drop to wallets that held ≥ 1,000 STEAK and interacted with STEAK contracts or the dashboard that week.
